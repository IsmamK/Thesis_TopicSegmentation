...
\begin{frame}{Same-Dataset TreeSeg Comparison}
  ...
  \end{table}
  \vspace{0.3em}
  \small TreeSeg-style splitting (our reimplementation on LECSEG-30) hits more exact boundaries but hurts Pk/WD.\\
  \small TreeSeg paper reports Pk=0.367 on their own TinyRec dataset (not directly comparable — different videos).
\end{frame}
