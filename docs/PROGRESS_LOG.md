...
## [2026-06-12 23:00] — Defense prep complete: slides v10b + full Q&A
...
- Updated defense/EXTERNAL_VALIDATION.md with real numbers and honest explanation: external videos (3Blue1Brown, Veritasium) have 2-3 min chapters vs 5-20 min for lectures — granularity mismatch explains degradation. Long lecture-format video (0B5eIE_1vpU, 129min, 6 chapters) achieves Pk=0.3974 consistent with benchmark.
...
- Wrote comprehensive Q&A: defense/qa_preparation.md — 7 parts, 50+ questions covering all angles (basics, dataset, methodology, novelty, results, limitations, adversarial, future work) + quick reference table with all key numbers.
