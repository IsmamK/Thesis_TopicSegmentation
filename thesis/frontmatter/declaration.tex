...
\begingroup
    ...
    \begin{center}
        \wildcard{\centerline{Ismam Khan} ~\\ \centerline{22101586}}
        \hspace{2cm}
        \wildcard{\centerline{Fahmida Afrin Moon} ~\\ \centerline{22101405}}
        \wildcard{\centerline{Md.\ Shahriar Islam Rafi} ~\\ \centerline{22301498}}
        \hspace{2cm}
        \wildcard{\centerline{Alimool Razi} ~\\ \centerline{22101306}}
        \wildcard[13cm]{\centerline{Sadia Alam} ~\\ \centerline{22101346}}
    \end{center}
