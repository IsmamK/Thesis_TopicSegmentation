...
\begin{center}
  \hspace{5cm}
  \wildcard{\centerline{Dr.\ Md.\ Golam Moazzam} ~\\
            \centerline{Associate Professor} ~\\
            \centerline{Dept.\ of Computer Science and Engineering} ~\\
            \centerline{BRAC University}}
\end{center}
...
\begin{center}
  \hspace{5cm}
  \wildcard{\centerline{Dr.\ Mahbubul Alam Majumdar} ~\\
            \centerline{Professor and Chairperson} ~\\
            \centerline{Dept.\ of Computer Science and Engineering} ~\\
            \centerline{BRAC University}}
\end{center}
