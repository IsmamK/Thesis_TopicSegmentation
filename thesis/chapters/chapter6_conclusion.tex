...
The contributions below are ordered by scientific significance rather than
...
\begin{itemize}
  ...
  \item \textbf{Multimodal signal reliability.}
    ...
    text fusion reaches $P_k=0.3740$, which is below the cross-model text method
...
segmentation systems succeed or fail. That is what a research benchmark is for.

\section{Recommendations for Future Work}

\input{chapters/chapter7_future_work}
