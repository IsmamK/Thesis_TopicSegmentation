...
agreement~\citep{fournier2012}, which is appropriate for a subjective
...
WindowDiff \citep{pevzner2002critique} corrects a known $P_k$ bias: $P_k$
...
\begin{description}
  \item[Boundary Similarity (BS, higher is better)] A boundary-level F-score
    variant normalised by boundary density~\citep{fournier2012}. Reported as
