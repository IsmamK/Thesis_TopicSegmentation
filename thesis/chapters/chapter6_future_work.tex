...
\section{Auditing LLM-assisted subtopic annotations}

Because subtopics were produced by LLM drafts followed by human review, future
work should measure whether the draft biases the final annotation. A small
subset of videos should be annotated independently from scratch by a second
human without seeing the LLM draft, then compared with the reviewed labels.
This would turn the current annotation-independence limitation into a measured
