...
\section{Independent validation of chapter references}

The most important dataset extension is not simply adding more videos; it is
validating whether creator-provided YouTube chapters agree with independent
human judgments. A focused validation study should select 8--10 lectures and
...
metrics. This would quantify how reliable the current creator chapters are as
reference boundaries.

\section{Expanded annotator pool and domain diversity}
...
and experience levels to measure whether subtopic agreement generalises beyond
the current annotator pool. A targeted extension annotating 8--10 additional
videos with three or more independent annotators would provide a Krippendorff's
$\alpha$ estimate alongside the existing Cohen's $\kappa$, and would allow
pairwise agreement patterns to be analysed rather than collapsed to a single
mean figure.

\section{External and Math-focused validation}
...
creator chapters and evaluate the final methods without retuning. If Math
performance improves, the likely cause was training scarcity; if it remains
weak, the problem is probably deeper, involving mathematical notation, stable
vocabulary, or gradual conceptual transitions. A separate 5--10 video external
test set from new channels should also be used to measure generalization beyond
\dataset{}.
...
\section{Public benchmark and model release}
